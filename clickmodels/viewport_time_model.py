...
class ComplexNormalViewportTimeModelMR(DefaultViewportTimeModel):
    def __init__(self, max_vertical_id):
        super(ComplexNormalViewportTimeModelMR, self).__init__()
        self.scale = 1000. # 可以自己调调
        self.epsilon = 0.1 / self.scale
        self.time_threshold = self.convert_v(VPT_EPSILON)
        self.max_vertical_id = 1 # max_vertical_id

        self.s_ep0 = [1.2 for _ in xrange(self.max_vertical_id)] # sigma
        self.m_ep0 = [-1. for _ in xrange(self.max_vertical_id)] # mu
        self.s_ep1_e0 = [1.18 for _ in xrange(self.max_vertical_id)]
        self.m_ep1_e0 = [0.35 for _ in xrange(self.max_vertical_id)]
        self.s_ep1_e1_r0 = [0.42 for _ in xrange(self.max_vertical_id)]
        self.m_ep1_e1_r0 = [1.09 for _ in xrange(self.max_vertical_id)]
        self.s_ep1_e1_r1_s0 = [0.56 for _ in xrange(self.max_vertical_id)]
        self.m_ep1_e1_r1_s0 = [1.79 for _ in xrange(self.max_vertical_id)]
        self.s_ep1_e1_r1_s1 = [0.56 for _ in xrange(self.max_vertical_id)]
        self.m_ep1_e1_r1_s1 = [1.79 for _ in xrange(self.max_vertical_id)]
    ...
    def get_method_name(self):
        return 'ComplexNormalViewportTimeModelMR'
    ...
    def P(self, v, **kwargs):
        ...
        if 'EP' in kwargs and kwargs['EP'] == 0:
            ...
            if 'E' in kwargs and kwargs['E'] == 0:
                ...
                if 'R' in kwargs and kwargs['R'] == 0:
                    s = self.s_ep1_e1_r0[layout]
                    m = self.m_ep1_e1_r0[layout]
                    # return max(self.normal_quality_function(v, s, m), self.epsilon)
                elif 'R' in kwargs and kwargs['R'] == 1:
                    if 'S_e' in kwargs and kwargs['S_e'] == 0:
                        s = self.s_ep1_e1_r1_s0[layout]
                        m = self.m_ep1_e1_r1_s0[layout]
                        # return max(self.normal_quality_function(v, s, m), self.epsilon)
                    elif 'S_e' in kwargs and kwargs['S_e'] == 1:
                        s = self.s_ep1_e1_r1_s1[layout]
                        m = self.m_ep1_e1_r1_s1[layout]
                        # return max(self.normal_quality_function(v, s, m), self.epsilon)
            return max(self.normal_quality_function(v, s, m), self.epsilon)
        else:
            ...
            if 'E' in kwargs and kwargs['E'] == 0:
                ...
                if 'R' in kwargs and kwargs['R'] == 0:
                    ...
                    if 'S_e' in kwargs and kwargs['S_e'] == 0:
                        ...
                        self.p_ep1_e1_r1_s1[layout].append(posterior)
                        self.v_ep1_e1_r1_s1[layout].append(v)
...
class ComplexNormalViewportTimeModelMRV2(DefaultViewportTimeModel):
    def __init__(self, max_vertical_id):
        super(ComplexNormalViewportTimeModelMRV2, self).__init__()
        self.scale = 1000. # 可以自己调调
        self.epsilon = 0.1 / self.scale
        self.time_threshold = self.convert_v(VPT_EPSILON)
        self.max_vertical_id = 1 # max_vertical_id
        ...
        self.s_ep0 = [1.2 for _ in xrange(self.max_vertical_id)] # sigma
        self.m_ep0 = [-1. for _ in xrange(self.max_vertical_id)] # mu
        self.s_ep1_e0 = [1.2 for _ in xrange(self.max_vertical_id)]
        self.m_ep1_e0 = [-1. for _ in xrange(self.max_vertical_id)]
        self.s_ep1_e1_r0 = [1.2 for _ in xrange(self.max_vertical_id)]
        self.m_ep1_e1_r0 = [-1. for _ in xrange(self.max_vertical_id)]
        self.s_ep1_e1_r1_s0 = [1.2 for _ in xrange(self.max_vertical_id)]
        self.m_ep1_e1_r1_s0 = [-1. for _ in xrange(self.max_vertical_id)]
        ...
        if 'EP' in kwargs and kwargs['EP'] == 0:
            ...
            if 'E' in kwargs and kwargs['E'] == 0:
                ...
                if 'R' in kwargs and kwargs['R'] == 0:
                    ...
                    if 'S_e_pre' in kwargs and 'S_e' in kwargs and kwargs['S_e_pre'] == kwargs['S_e']:
                        s = self.s_ep1_e1_r1_s0[layout]
                        m = self.m_ep1_e1_r1_s0[layout]
                        # return max(self.normal_quality_function(v, s, m), self.epsilon)
                    elif 'S_e_pre' in kwargs and 'S_e' in kwargs and kwargs['S_e_pre'] + 1 == kwargs['S_e']:
                        s = self.s_ep1_e1_r1_s1[layout]
                        m = self.m_ep1_e1_r1_s1[layout]
                        # return max(self.normal_quality_function(v, s, m), self.epsilon)
                    elif 'S_e_pre' in kwargs and 'S_e' in kwargs and kwargs['S_e_pre'] + 2 == kwargs['S_e']:
                        s = self.s_ep1_e1_r1_s2[layout]
                        m = self.m_ep1_e1_r1_s2[layout]
                        # return max(self.normal_quality_function(v, s, m), self.epsilon)
                    else:
                        raise ValueError('ComplexNormalViewportTimeModelMR P() input error!')
                else:
            ...
            if 'E' in kwargs and kwargs['E'] == 0:
                ...
                if 'R' in kwargs and kwargs['R'] == 0:
                    ...
                    if 'S_e_pre' in kwargs and 'S_e' in kwargs and kwargs['S_e_pre'] == kwargs['S_e']:
                        ...
                        self.p_ep1_e1_r1_s2[layout].append(posterior)
                        self.v_ep1_e1_r1_s2[layout].append(v)
